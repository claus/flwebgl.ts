...
module flwebgl.e.shaders
{
  ...
  export class ShaderImageSpaceStdDev implements IShader
  {
    private gl: GL;
    private _id: number;
    private _attribs: VertexAttributes;
    ...
    setup(): boolean {
      ...
      var u2 = new Uniform(ul2, GL.INT, 1, Uniform.Q); // TODO: not used?
      ...
      var a0 = new VertexAttribute(al0, "POSITION0", GL.FLOAT, 2);
      var a1 = new VertexAttribute(al1, "TEXCOORD0", GL.FLOAT, 2);
      var a2 = new VertexAttribute(al2, "TEXCOORD1", GL.FLOAT, 1);
      var a3 = new VertexAttribute(al3, "TEXCOORD2", GL.FLOAT, 2);
      this._attribs = new VertexAttributes([ a0, a1, a2, a3 ]);
      return true;
    }
