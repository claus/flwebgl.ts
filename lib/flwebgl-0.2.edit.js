      ...
      a.prototype.parseShapes = function () {
        ...
        for (var i = 0; i < shapes.length; i++) {
          ...
          for (var j = 0; j < meshes.length; j++) {
            ...
            var u = this.Kb.If(vertices, fillName, fillStyle, fillMatrix, fillOverflow, fillIsBitmapClipped, fillIsOpaque, internalIndices);
            var A = this.Kb.If(vertices, fillName, fillStyle, fillMatrix, fillOverflow, fillIsBitmapClipped, fillIsOpaque, [], concaveCurveIndices, convexCurveIndices, edgeIndices);
            var f = this.Kb.dj(vertices, concaveCurveIndices, convexCurveIndices, edgeIndices, fillName, fillStyle, fillIsOpaque, fillMatrix, fillOverflow, fillIsBitmapClipped);
            var k;
            if (u.length) {
      ...
      b.prototype.Qg = function (a) {
        ...
        for (var c = a.length, f = 0; f < c; ++f) {
          for (var e = a[f], k = 0; k < e.ra(d.t.Z); k++) {
            ...
            l.getIsOpaque() && this.cg.Dc(l)
          }
          for (k = 0; k < e.ra(d.t.P); k++) l = e.ab(d.t.P, k, this.a), l.getIsOpaque() && this.cg.Dc(l)
        }
        f = e = 0;
        for (l = []; e < c;) {
          for (var s = a[e].Fa(), m = s, n = -1, y = [], w = [], t = this.yi(), q = this.yi(), k = e; k < c; ++k, ++f) {
            for (var e = a[k], r = e.Fa(), u = false, A = e.ra(d.t.Z), C = e.ra(d.t.P), v = 0; !u && v < A; ++v) u = !e.ab(d.t.Z, v, this.a).getIsOpaque();
            for (v = 0; !u && v < C; ++v) u = !e.ab(d.t.P, v, this.a).getIsOpaque();
            if (u) {
              n = r;
          ...
          if (-1 != n && n == s) {
            for (k = f; k < c; ++k, ++f) {
              ...
              A = e.ra(d.t.Z);
              C = e.ra(d.t.P);
              for (v = 0; v < A; v++)(s = e.ab(d.t.Z, v, this.a)) && !s.getIsOpaque() && w.push(s);
              for (v = 0; v < C; v++) A = e.ab(d.t.P, v, this.a), x = e.ab(d.t.bb, v, this.a), A.getIsOpaque() ? (l.push(A), x && l.push(x)) : (w.push(A), x && w.push(x))
            }
            if (0 < w.length) {
  ...
  (function (d) {
    ...
    f = function () {
      ...
      b.prototype.nn = function (a) {
        if (a.Li === void 0 || a.getColor() === void 0 || a.pa === void 0) {
          return false;
        }
        this.wc.push(a);
        return true;
      ...
      b.prototype.Qn = function () {
        ...
        if (a !== 0) {
          for (var b = 0; b < a; ++b) {
            ...
            if (m !== void 0) {
              l.In(m);
              e = this.Ti.createShape(m.getMesh().getID(), this.Ti.rm());
              l.Hn(e);
              l.Ea(s);
              f.$j(l);
            } else {
          ...
          this.wc.length = 0;
          var viewport = this.a.getViewport();
          var texMax = new c.c.M(0, 0, d.d.MAX_TEXTURE_SIZE, d.d.MAX_TEXTURE_SIZE);
          this.a.setViewport(texMax, false);
          for (var y in this.Yb) {
            this.Yb[y].pn(this.a);
          }
          this.a.setViewport(viewport);
        }
      };
      b.prototype.Qk = function (a, b, c, e) {
        ...
        if (a !== void 0) {
          for (var d = 0; d < a.length; ++d) {
            var f = a[d];
            if (f.getColor().equals(b) && this.el(c, f.ub()) && f.La().equals(e)) {
              return f;
            }
          }
        }
      ...
      b.prototype.pa = function (a, b, d, e) {
        var f = c.l.U.sm(a);
        var l = a.getLocalTransform().clone();
        l.invert();
        a.Ea(l, e);
        var s = a;
        ...
        if (m.left && !isNaN(m.left)) {
          ...
          if (y === void 0) {
            ...
            if (w === void 0) {
              ...
              f = this.Tk(m, s, y.Cd(), w, b.ve === 255);
              if (f === void 0) {
                y.nj(w);
              } else {
                n = this.ce[a.Ic().getID()];
                if (n === void 0) {
                  n = [];
                  this.ce[a.Ic().getID()] = n;
                }
                d = new c.e.wk(y.Cd(), f, a.Ic().getID(), b, d, a.getGlobalColorTransform());
                n.push(d);
                n = y.getFrame(w);
                s.Ga(l);
                l = s.get(0, 3);
                f = s.get(1, 3);
                s.translate(n.left + (l - Math.floor(l)), n.top + (f - Math.floor(f)));
                a.Ea(s, e);
                a.Qb(this.oa);
                y.mn(this.oa, w, b);
                this.oa.length = 0;
      ...
      b.prototype.Tk = function (a, b, d, e, f) {
        if (a !== void 0 && d !== void 0 && e !== void 0) {
          var l = new c.e.t(this.T.getNextAvailableAssetID());
          var s = this.a.H.hasExtension("OES_standard_derivatives") ? 7 : 11;
          a = this.Xk(s, a, b);
      ...
      b.prototype.Xk = function (a, b, d) {
        var e = new c.c.k(b.left, b.top);
        var f = new c.c.k(b.left + b.width, b.top);
        var l = new c.c.k(b.left + b.width, b.top + b.height);
        var b = new c.c.k(b.left, b.top + b.height);
  ...
  (function (d) {
    var f = function () {
      ...
      b.prototype.kn = function (a, c, d) {
        if (this.cf(a) !== false) {
          (0 < d && d--, d = { loop: d }, c === b.Sh ? (a = this.zi(a, c), a.play(d)) : c === b.Th ? this.gl(a) || (a = this.zi(a, c), a.play(d)) : c === b.uk && this.Kl(a))
        }
      };
      b.prototype.tn = function (sounds, soundsLoadedCallback) {
        this.nb = sounds;
  ...
  (function (d) {
    var f = function () {
      ...
      b.prototype.createMovieClipInstance = function (linkageName) {
        var a = this.context.T.getTimelineByName(linkageName);
      ...
      b.prototype.createShape = function (a, b) {
        ...
        shape.Of(this.context.T.getMesh(a));
        shape.setID(b);
        return shape;
      };
      b.prototype.createMovieClip = function (a, b) {
        ...
        if (a !== void 0) {
          mc.Of(this.context.T.getTimeline(a));
        }
        mc.setID(b);
        return mc;
      };
...
(function (c) {
  var d = function () {
    ...
    d.prototype.init = function (canvas, content, textures, callback, options) {
      ...
      if (b) {
        this.context = new c.nk(this.a, this.Ta, this.Ac);
        this.scenegraphFactory = new flwebgl.sg.SceneGraphFactory(this.context, this.ge.ac + 1);
        if (this.options[d.kOption_CacheAsBitmap]) {
          this.nd = new c.e.xk(this.a, this.Ta, this.scenegraphFactory);
        }
        this.context.Gn(this.scenegraphFactory);
        ...
        if (this.Ta.getSounds().length > 0) {
          this.Ac.tn(this.Ta.getSounds(), c.l.U.bind(this, "_soundsLoadedCBK"))
        } else {
    ...
    d.prototype.play = function (b) {
      ...
      if (b && b.length) {
        for (var p = false, e = 0; e < this.timelines.length; e++)
          if (this.Ta.getTimeline(this.timelines[e]).getName() === b) {
            a = e;
            p = true;
            this.jd = false;
            break;
    ...
    d.prototype.Ri = function (b, a) {
      ...
      this.Hi = -1;
      if (a || b !== this.rc) {
        var c = this.Ta.getTimeline(this.timelines[b]);
        this.stage.Of(c);
        this.stage.play();
