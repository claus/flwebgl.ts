...
(function (c) {
  (function (d) {
    var f = function () {
      ...
      b.prototype.ab = function (edgeType, i, b) {
        var e = this.Gb[edgeType][i];
        if (!e) {
          var e = this.shape.Ic();
          var k = e.yf(edgeType, i);
          if (!k) {
            return;
          }
          e = new c.e.lk(c.l.U.cm(e.getID(), i, edgeType), k, b.Be(k.ad).getID(), this);
          //             "meshid_i_edgetype",             bufs, atlasid, parent
          this.Gb[edgeType][i] = e;
        }
        return e;
      };
      b.prototype.getTransform = function () {
  ...
  (function (d) {
    var f = function (b) {
      ...
      a.prototype.getBounds = function (target, fast, e, k) {
        ...
        return fast ? a.transformBoundsAABB(this.yc.bounds) : this.calculateBoundsAABB(e, a);
      };
...
(function (c) {
  (function (d) {
    var f = function () {
      function b() {}
      b.requestAnimationFrame = function (fn, frameRate, c) {
        ...
        return rAF ? rAF(fn) : c.setTimeout(fn, 1000 / frameRate);
      };
...
// flwebgl.B.Wf
// flwebgl.B.commands.PlaceObjectCommand
(function (c) {
  (function (d) {
    var f = function () {
      function b(a) {
...
// flwebgl.B.Ph
// flwebgl.B.commands.RemoveObjectCommand
(function (c) {
  (function (c) {
    var f = function () {
      function b(a) {
...
// flwebgl.B.bi
// flwebgl.B.commands.SetTransformCommand
(function (c) {
  (function (d) {
    var f = function () {
      function b(a) {
...
// flwebgl.B.ai
// flwebgl.B.commands.SetColorTransformCommand
(function (c) {
  (function (d) {
    var f = function () {
      function b(a) {
...
// flwebgl.B.Vh
// flwebgl.B.commands.SetVisibilityCommand
(function (c) {
  (function (c) {
    var f = function () {
      function b(a) {
...
// flwebgl.B.Wh
// flwebgl.B.commands.CacheAsBitmapCommand
(function (c) {
  (function (d) {
    var f = function () {
      function b(a) {
      ...
      b.prototype.execute = function (a, b) {
        ...
        var d = new c.e.yk(displayObject, this.color, colorTransform, new c.e.vk);
        return b.nd.nn(d);
      };
      return b
    }();
...
// flwebgl.e.Ak
// flwebgl.e.shaders.ShaderMSAAStdDev
(function (c) {
  (function (d) {
    var f = function () {
      function b() {}
...
// flwebgl.e.kk
// flwebgl.e.renderers.RendererMSAA
(function (c) {
  (function (d) {
    var f = function () {
      function b() {}
...
// flwebgl.e.ek
// flwebgl.e.shaders.ShaderImageSpaceCoverage
(function (c) {
  (function (d) {
    var f = function () {
      function b() {}
...
// flwebgl.e.hk
// flwebgl.e.shaders.ShaderImageSpaceStdDev
(function (c) {
  (function (d) {
    var f = function () {
      function b() {}
...
// flwebgl.e.ik
// flwebgl.e.shaders.ShaderImageSpace
(function (c) {
  (function (d) {
    var f = function () {
      function b() {}
  ...
  (function (d) {
    ...
    var f = function () {
      function b(a, b, d, e, f, l) {
        ...
        this.$n = d;
        this.color = e;
        this.transform = f.clone();
        this.colorTransform = (l !== void 0) ? l.clone() : new c.c.p;
        this.ug = 0
      }
      b.prototype.getTextureID = z("textureID");
      b.prototype.getMesh = z("mesh");
      b.prototype.getColor = z("color");
      b.prototype.getTransform = z("transform");
      b.prototype.getColorTransform = z("colorTransform");
