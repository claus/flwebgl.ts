  ...
  (function (d) {
    var f = function () {
      ...
      b.prototype.bk = function (a) {
        ...
        var b = this.transformPoint(h);
        h.x = a.left + a.width;
        var e = this.transformPoint(h);
        h.y = a.top + a.height;
        var k = this.transformPoint(h);
        h.x = a.left;
        var l = this.transformPoint(h);
    ...
    var f = function () {
      ...
      b.prototype.destroy = function () {
        for (var a = [d.t.Z, d.t.P, d.t.bb], h = 0; h < a.length; ++h)
          for (var b = a[h], e = 0; e < this.Gb[b].length; ++e) this.Gb[b][e] && (this.Gb[b][e].destroy(), delete this.Gb[b][e])
      };
      return b
    }();
    d.qk = f
      ...
      a.prototype.cl = function (a, b) {
        for (var e = new c.c.M, k = this.yc.ra(a), l = new c.c.k(0, 0), d = 0; d < k; ++d)
          for (var m = this.yc.yf(a, d), n = m.qj(), m = m.nc(n[0]), n = 0; n < m.length; ++n)
            for (var y = m[n], w = y.jc.attrs, f = 0; f < w.length; ++f) {
              var q = w[f];
              if ("POSITION0" === q.pc) {
                w = y.ba;
                y = y.jc.totalSize / Float32Array.BYTES_PER_ELEMENT;
                for (q = q.byteOffset / Float32Array.BYTES_PER_ELEMENT; q < w.length; q += y) l.x = w[q], l.y = w[q + 1], l = b.transformPoint(l),
  ...
  (function (d) {
    ...
    var b = function () {
      ...
      b.prototype.Uk = function (a, b, h, k, e, d, p) {
        if (!(0 >= k || 6 != e.length))
          for (e = new c.c.u(e), e.Rb(), d /= 20, p /= 20, e.set(0, 0, e.get(0, 0) / d), e.set(1, 0, e.get(1, 0) / p), e.set(0, 1, e.get(0, 1) / d), e.set(1, 1, e.get(1, 1) / p), e.set(0, 3, e.get(0, 3) / d), e.set(1, 3, e.get(1, 3) / p), p = 0, d = h; p < b * k; p += b, d += b) h = e.transformPoint(new c.c.k(a[p], a[p + 1])), a[d] = h.x, a[d + 1] = h.y
      };
      ...
      b.prototype.e = function (a) {
        for (var b = a.F.length, c = this.a.kf, e = 0; e < b; ++e) {
          ...
          if (k.Jc()) {
            ...
            var t = this.V.b,
              q = k.Ce(this.getID());
            void 0 === q ? (q = [], q.push(new d.D(this.o.uMVMatrix, t)), q.push(new d.D(this.o.uSampler, [n])), q.push(new d.D(this.o.uColorXformMultiplier, [m.getRedMultiplier(), m.getGreenMultiplier(), m.getBlueMultiplier(), m.getAlphaMultiplier()])), q.push(new d.D(this.o.uColorXformOffset, [m.getRedOffset() / 255, m.getGreenOffset() / 255, m.getBlueOffset() / 255, m.getAlphaOffset() / 255])), q.push(new d.D(this.o.uOverflowType, [y])), q.push(new d.D(this.o.uFrame, [f.left / w, f.top / s, f.width / w, f.height / s]))) : (q[0].value = t, q[1].value = [n], q[2].value = [m.getRedMultiplier(), m.getGreenMultiplier(), m.getBlueMultiplier(), m.getAlphaMultiplier()], q[3].value = [m.getRedOffset() / 255, m.getGreenOffset() / 255, m.getBlueOffset() / 255, m.getAlphaOffset() / 255], q[4].value = [y], q[5].value = [f.left / w, f.top / s, f.width / w, f.height / s]);
            k.Pf(this.getID(), q)
          }
        }
        0 < a.F.length &&
        ...
        for (var b = a.F.length, c = this.a.kf, e = 0; e < b; ++e) {
          ...
          if (k.Jc()) {
            ...
            void 0 === q ? (q = [], q.push(new d.D(this.o.uMVMatrix,
              t)), q.push(new d.D(this.o.uMVMatrixInv, [this.N.get(0, 0), this.N.get(0, 1), this.N.get(1, 0), this.N.get(1, 1)])), q.push(new d.D(this.o.uSampler, [n])), q.push(new d.D(this.o.uColorXformMultiplier, [m.getRedMultiplier(), m.getGreenMultiplier(), m.getBlueMultiplier(), m.getAlphaMultiplier()])), q.push(new d.D(this.o.uColorXformOffset, [m.getRedOffset() / 255, m.getGreenOffset() / 255, m.getBlueOffset() / 255, m.getAlphaOffset() / 255])), q.push(new d.D(this.o.uOverflowType, [y])), q.push(new d.D(this.o.uFrame, [f.left / w, f.top / s, f.width / w, f.height / s]))) : (q[0].value = t, q[1].value = [this.N.get(0, 0), this.N.get(0, 1), this.N.get(1, 0), this.N.get(1,
              1)], q[2].value = [n], q[3].value = [m.getRedMultiplier(), m.getGreenMultiplier(), m.getBlueMultiplier(), m.getAlphaMultiplier()], q[4].value = [m.getRedOffset() / 255, m.getGreenOffset() / 255, m.getBlueOffset() / 255, m.getAlphaOffset() / 255], q[5].value = [y], q[6].value = [f.left / w, f.top / s, f.width / w, f.height / s]);
            k.Pf(this.getID(), q)
          }
        }
