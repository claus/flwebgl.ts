  ...
  (function (c) {
    var f = function () {
      ...
      b.prototype.ub = function () {
        return this.parent.ub()
      };
      b.prototype.La = function () {
        return this.parent.La()
      };
      b.prototype.Fa = function () {
        return this.parent.Fa()
      };
      b.prototype.Jc = function () {
        return this.parent.Jc()
      };
      b.prototype.Sb = function () {
        var a = this.parent.La();
        return (this.ka.Sb() && a.getAlphaMultiplier() == 1 && a.getAlphaOffset() == 0)
      };
  ...
  (function (d) {
    var f = function () {
      ...
      b.prototype.transformPoint = function (a) {
        ...
        h.y = this.b[1] * a.x + this.b[4] * a.y + this.b[7];
        return h
      };
      b.prototype.invert = function () {
        var a = this.b[0],
  ...
  (function (d) {
    var f = function (b) {
      ...
      a.prototype.getBounds = function (a, b, e, k) {
        ...
        void 0 === a && (a = this);
        if (true === k) {
          k = a.getGlobalTransform();
          a = this.getGlobalTransform();
        } else {
          k = new c.c.u;
          var l = a;
          while (l) {
            k.concat(l.getLocalTransform());
            l = l.getParent();
          }
          k.invert();
          a = new c.c.u;
          l = this;
          while (l) {
            a.concat(l.getLocalTransform());
            l = l.getParent();
          }
          a.concat(k);
        }
        return b ? a.transformBoundsAABB(this.yc.bounds) : this.cl(e, a);
      };
  ...
  (function (d) {
    var f = function (b) {
      ...
      a.prototype.addChildAt = function (displayObject, index, e, k) {
        ...
        displayObject.Ea(this.globalTransform, this.globalColorTransform);
        ...
        if (displayObject instanceof a) {
          ...
          if (p == this.canvas.getStage() && displayObject.getCurrentFrame() == 0) {
      ...
      a.prototype.gotoFrame = function (frameNum, stop) {
        if (typeof frameNum === "string") {
          var labels = this.Va.getFrameLabels();
          var found = false;
      ...
      a.prototype.advanceFrame = function (a, b) {
        ...
        if (advance) {
          if (++this.currentFrameIndex == this.totalFrames) {
            ...
            var e = a && !b;
            if (e) { this.Td = true; }
            var cmds = this.Va.getFrameCmds(this.currentFrameIndex);
            for (i = 0; i < cmds.length; i++) {
              cmds[i].execute(this, this.canvas, e);
            }
            this.Td = false;
          }
          this.df = true;
      ...
      a.prototype.constructFrame = function (a) {
        ...
        for (b = 0; b < this.Y.length; b++) {
          ...
          e.Ea(this.globalTransform, this.globalColorTransform);
          if (!a) {
      ...
      a.prototype.executeFrameScripts = function () {
        if (this.df) {
          var a = this.Va.getScriptFunctionNames(this.currentFrameIndex);
          for (var b = 0; b < a.length; ++b) {
            this.executeFrameScript(a[b]);
          }
          this.df = false;
        }
        for (a = 0; a < this.children.length; a++) {
          if (this.children[a] instanceof c.g.j) {
            this.children[a].executeFrameScripts();
          }
        }
      };
      ...
      a.prototype.Of = function (a) {
        this.Va = a;
        this.currentFrameIndex = -1;
        this.totalFrames = this.Va.frameCmds.length
      };
      a.prototype.Ic = z("Va");
  ...
  (function (d) {
    var f = function () {
      ...
      b.prototype.execute = function (a) {
        ...
        if ((a.W & 2) === 0) {
          a.setLocalColorTransform(this.dg, false);
        }
        return true;
      };
      return b
...
(function (c) {
  (function (d) {
    var f = function () {
      ...
      b.prototype.execute = function (a, b) {
        var d = a.getChildIndexByID(this.X);
        if (d < 0) {
          return false;
        }
        ...
        var e = a.getGlobalColorTransform().clone();
        var k = new c.e.vk;
        var d = new c.e.yk(d, this.Rd, e, k);
        return b.nd.nn(d);
      };
      return b
    }();
  ...
  (function (c) {
    var f = function () {
      ...
      b.prototype.execute = function (a, b, c) {
        if (!c) {
          b.Ac.kn(this.X.toString(), this.Ol, this.ll);
        }
        return true;
      };
      return b
  ...
  (function (d) {
    ...
    var b = function () {
      ...
      b.prototype.If = function (vertices, fillName, fillStyle, fillMatrix, fillOverflow, fillIsBitmapClipped, fillIsOpaque, internalIndices, concaveCurveIndices, convexCurveIndices, edgeIndices) {
        ...
        var C = [];
        var v = [];
        var x; // edge type (internal / external)
        if (internalIndices.length > 0) {
          x = c.e.t.Z; // edge type internal
          v = this.xl(vertices, internalIndices);
        } else {
          x = c.e.t.P; // edge type external
        ...
        for (var a = 0; a < v.length; a++) {
          ...
          u.Ke(this.xi(fillStyle, fillOverflow, fillIsBitmapClipped));
          C.push(u);
        }
        return C;
      };
      b.prototype.dj = function (a, b, h, k, e, d, f, q, r, u) {
        ...
        for (var A = 0, C = 0, v = 0, x = 0, B = 0, I = x = 0, K =
            0, T = b.length + h.length + k.length, X = [], U = 3 * Math.floor(c.e.d.MAX_VERTICES / 6); C < T;) {
          var A = C,
            C = T - C > U ? C + U : T,
            L = C - A,
            A = [],
          ...
          H.ba = A;
          H.Ma = R;
          var A = this.injectTexCoords(H, e, d, q),
            L = new c.e.ca(e, f),
            R = c.e.t.bb,
            ba;
          for (ba in A) F = A[ba], this.enableStandardDerivatives && this.ti(R, F, H.Ma.length), W = this.te, F = new c.e.Pd(new Float32Array(F), W), L.xe(ba, [F]), L.we(new Uint16Array(H.Ma));
          L.Ke(this.xi(d,
            r, u));
          X.push(L)
        }
      ...
      b.prototype.parse = function (content, options) {
        ...
        var p = (header[b.kReadable] == true) ? new a(content, this, this.T) : new e(content, this, this.T);
        this.enableCacheAsBitmap = options[c.n.kOption_CacheAsBitmap];
        this.enableStandardDerivatives = options[c.n.kOption_StandardDerivatives];
        this.S = 7;
        if (this.enableStandardDerivatives) {
          this.S += 4;
        }
      ...
      b.prototype.parseTextureAtlas = function (textureJSON, imageURL, i) {
        ...
        this.T.setTextureAtlas(textureAtlas);
        return true;
      };
      ...
      b.prototype.injectTexCoords = function (b, fillName, fillStyle, fillMatrix) {
        var d = {};
        var p = this.T.getTextureAtlases();
      ...
      b.prototype.xi = function (b, h, k) {
        ...
        switch (b) {
          ...
          case a.kBitmap:
          case e.kBitmap:
            d = c.e.ca.fillMode[k ? c.e.ca.kFill_Repeat : c.e.ca.kFill_Extend];
            break;
        }
        return d;
      };
      ...
      b.prototype.bl = function (a, b) {
        ...
        var e = b[1].sub(b[0]);
        var k = b[2].sub(b[0]);
        var h = new c.c.Vf([ h.x, h.y, 1, e.x, e.y, 1, k.x, k.y, 1 ]);
        h.invert();
        e = a[0];
        k = a[1];
        a[0] = 0;
    ...
    var a = function () {
      ...
      a.prototype.parseFills = function () {
        ...
        for (var i = 0; i < b.length; i++) {
          ...
          this.Yd[b[i][a.kName]] = (b[i][a.kIsOpaque] == "T") ? true : false;
      ...
      a.prototype.parseShapes = function () {
        ...
        for (var h = 0; h < shapes.length; ++h) {
          var shape = shapes[h];
          var d = new c.e.t(shape[a.kId]);
          var meshes = shape[a.kMeshes];
          for (var p = 0; p < meshes.length; ++p) {
            var mesh = meshes[p];
            var fillName = this.Xd[mesh[a.kFillId]];
            var fillStyle = this.Zd[fillName];
            var fillIsOpaque = this.Yd[fillName];
            var u = this.Kb.If(mesh[a.kVertices], fillName, fillStyle, mesh[a.kFillMatrix], mesh[a.kOverflow], mesh[a.kIsBitmapClipped], fillIsOpaque, mesh[a.kInternalIndices]);
            var A = this.Kb.If(mesh[a.kVertices], fillName, fillStyle, mesh[a.kFillMatrix], mesh[a.kOverflow], mesh[a.kIsBitmapClipped], fillIsOpaque, [], mesh[a.kConcaveCurveIndices], mesh[a.kConvexCurveIndices], mesh[a.kEdgeIndices]);
            var f = this.Kb.dj(mesh[a.kVertices], mesh[a.kConcaveCurveIndices], mesh[a.kConvexCurveIndices], mesh[a.kEdgeIndices], fillName, fillStyle, fillIsOpaque, mesh[a.kFillMatrix], mesh[a.kOverflow], mesh[a.kIsBitmapClipped]);
            if (u.length) {
            ...
            for (q = 0; q < frame[a.kFramesCmds].length; ++q) {
              switch (frame[a.kFramesCmds][q][0]) {
                ...
                case 5:
                  ...
                  break;
                case 6:
                  if (this.Kb.enableCacheAsBitmap) {
    ...
    var e = function () {
      ...
      a.prototype.parseShapes = function () {
        ...
        for (var i = 0; i < shapes.length; i++) {
          ...
          for (var j = 1; j < shape.length; j++) {
            ...
            var f = this.Kb.If(vertices, fillName, fillStyle, fillMatrix, fillOverflow, fillIsBitmapClipped, fillIsOpaque, internalIndices);
            var q = this.Kb.If(vertices, fillName, fillStyle, fillMatrix, fillOverflow, fillIsBitmapClipped, fillIsOpaque, [], concaveCurveIndices, convexCurveIndices, edgeIndices);
            var t = this.Kb.dj(vertices, concaveCurveIndices, convexCurveIndices, edgeIndices, fillName, fillStyle, fillIsOpaque, fillMatrix, fillOverflow, fillIsBitmapClipped);
            var k;
            if (f.length) {
      ...
      a.prototype.parseTimelines = function () {
        var b = this.content[a.kTimelines];
            ...
            for (t = 0; t < d.length; ++t) {
              switch (d[t][0]) {
                ...
                case 5:
                  ...
                  break;
                case 6:
                  this.Kb.enableCacheAsBitmap && (f = new c.B.Wh(d[t].slice(1)));
                  break;
                case 7:
      ...
      a.prototype.parseSounds = function () {
        for (var b = this.content[a.kSounds], h = 0; h < b.length; ++h) {
          var e = b[h],
  ...
  (function (c) {
    var f = function () {
      function a(b) {
        ...
        if (0 > this.$b || this.$b < c.d.MAX_VERTICES) this.$b = c.d.MAX_VERTICES;
        this.ji = {};
      ...
      a.prototype.Si = function (a, b, e) {
        ...
        for (var k = this.Oa.ta, n = 0; n < b.length; n++)
          if (e.ck[n]) {
            var y = b[n].nc()[0].ba,
              w = e.wh[n].Ld;
            this.a.bufferSubData(c.d.ARRAY_BUFFER, w * this.Oa.ta[0].totalSize, y);
        ...
        for (var q = 1; q < k.length; ++q) {
          ...
          for (n = 0; n < b.length; n++) e.ck[n] && (y = b[n].nc()[q].ba, w = e.wh[n].Ld, this.a.bufferSubData(c.d.ARRAY_BUFFER, w * this.Oa.ta[q].totalSize, y), void 0 !== this.pd && this.pd(y.length * Float32Array.BYTES_PER_ELEMENT));
          y = k[q];
          n = y.attrs;
          y =
            y.totalSize;
          if (void 0 === m) {
            ...
            for (w = 0; w < n.length; ++w) t = this.Uc.getAttribs(n[w].pc), f && this.a.kc(t.location), this.a.vertexAttribPointer(t.location, t.size, t.type, t.Hf, y, n[w].byteOffset);
  ...
  (function (d) {
    var f = function () {
      ...
      b.prototype.Vg = function (a, b) {
        ...
        if (void 0 === this.rd[c]) {
          var e = d.d.MAX_VERTICES * this.Oa.ta[0].totalSize * Float32Array.BYTES_PER_ELEMENT,
      ...
      b.prototype.Zg = function () {
        this.a.$g(d.d.ARRAY_BUFFER) !== this.Cg && (this.a.ga(d.d.ARRAY_BUFFER, this.Cg),
          this.oe());
        for (var a = [], b = 0, p = this.Oa.ta[0].totalSize, e = 0; e < this.kb.length; e++) {
          var k = new c.e.mk;
      ...
      b.prototype.upload = function (a) {
        if (this.gc + a.sa() > d.d.MAX_VERTICES) return false;
        this.kb.push(a);
        this.gc += a.sa();
        return true
      };
      ...
      b.prototype.oe = function () {
        for (var a = this.Oa.ta, b = 0; b < a.length; ++b)
          for (var c =
              a[b], e = c.attrs, c = c.totalSize, d = 0; d < e.length; ++d) {
  ...
  (function (d) {
    var f = function () {
      ...
      b.prototype.Be = function (a) {
        for (var b = void 0, c = 0; c < this.xb.length; c++)
          if (void 0 !== this.xb[c].getFrame(a)) {
            b = this.xb[c];
            break
          }
        return b
  ...
  (function (d) {
    var f = function () {
      ...
      b.prototype.Xb = function () {
        this.a.useProgram(this.program)
      };
      b.prototype.Ua = function () {
        ...
        this.fragmentShaderSrc =
          ...
          "}";
        this.vertexShader = this.a.createShader(d.d.VERTEX_SHADER, this.vertexShaderSrc);
        this.fragmentShader = this.a.createShader(d.d.FRAGMENT_SHADER, this.fragmentShaderSrc);
        this.program = this.a.createProgram();
        this.a.attachShader(this.program, this.vertexShader);
        this.a.attachShader(this.program, this.fragmentShader);
        this.id = this.a.linkProgram(this.program);
        if (this.v < 0) {
          this.a.deleteProgram(this.program);
          c.l.w.error("Program linking failed.");
          return false;
        }
        var ul0 = this.a.getUniformLocation(this.program, "uMVMatrix");
        var ul1 = this.a.getUniformLocation(this.program, "uSampler");
        var ul2 = this.a.getUniformLocation(this.program, "uColorXformMultiplier");
        var ul3 = this.a.getUniformLocation(this.program, "uColorXformOffset");
        var ul4 = this.a.getUniformLocation(this.program, "uOverflowType");
        var ul5 = this.a.getUniformLocation(this.program, "uFrame");
        ...
        this.o.uFrame = u5;
        var al0 = this.a.getAttribLocation(this.program, "aVertexPosition");
        var al1 = this.a.getAttribLocation(this.program, "aLoopBlinnTextureCoord");
        var al2 = this.a.getAttribLocation(this.program, "aIsConvex");
        var al3 = this.a.getAttribLocation(this.program, "aTextureCoord");
      ...
      b.prototype.destroy = function () {
        this.a.deleteShader(this.vertexShader);
        this.a.deleteShader(this.fragmentShader);
        this.a.deleteProgram(this.program);
      };
      b.Om = 7;
      return b
  ...
  (function (d) {
    var f = function () {
        ...
        for (var e = 0; e < b; ++e) {
          ...
          if (k.Jc()) {
            ...
            if (q === void 0) {
              ...
              q[5].value = [y];
              q[6].value = [f.left / w, f.top / s, f.width / w, f.height / s];
            }
            k.Pf(this.getID(), q);
          }
        }
      ...
      b.prototype.Ua = function () {
        ...
        var ul0 = this.a.getUniformLocation(this.program, "uMVMatrix");
        var ul1 = this.a.getUniformLocation(this.program, "uMVMatrixInv");
        var ul2 = this.a.getUniformLocation(this.program, "uSampler");
        var ul3 = this.a.getUniformLocation(this.program, "uColorXformMultiplier");
        var ul4 = this.a.getUniformLocation(this.program, "uColorXformOffset");
        var ul5 = this.a.getUniformLocation(this.program, "uOverflowType");
        var ul6 = this.a.getUniformLocation(this.program, "uFrame");
        var u0 = new d.q(ul0, d.d.FLOAT_MAT4, 1, d.q.Jd);
        ...
        var al2 = this.a.getAttribLocation(this.program, "aIsConvex");
        var al3 = this.a.getAttribLocation(this.program, "aTextureCoord");
        var al4 = this.a.getAttribLocation(this.program, "adfdx");
        var al5 = this.a.getAttribLocation(this.program, "adfdy");
        var a0 = new d.R(al0, "POSITION0", d.d.FLOAT, 2);
        var a1 = new d.R(al1, "TEXCOORD0", d.d.FLOAT, 2);
        var a2 = new d.R(al2, "TEXCOORD1", d.d.FLOAT, 1);
        var a3 = new d.R(al3, "TEXCOORD2", d.d.FLOAT, 2);
      ...
      b.prototype.Qg = function (a) {
        for (var c = 0; c < a.length; ++c) {
          ...
          for (var e = 0; e < f.ra(d.t.Z); e++) {
            ...
            var l = k.Sb() ? b.Ee : b.Ed;
            this.qc[l].Dc(k);
          }
          for (e = 0; e < f.ra(d.t.P); e++) {
            k = f.ab(d.t.P, e, this.a);
            this.qc[b.Ed].Dc(k);
          }
        }
      };
...
(function (c) {
  (function (d) {
    var f = function () {
      ...
      b.prototype.Xb = function () {
        this.a.useProgram(this.program);
        this.a.ga(d.d.ARRAY_BUFFER, this.vertexBuffer);
        this.a.ga(d.d.ELEMENT_ARRAY_BUFFER, this.indexBuffer);
        this.a.useProgram(this.program);
      ...
      b.prototype.Ua = function () {
        ...
        this.vertexBuffer = this.a.createBuffer();
        if (this.vertexBuffer === void 0) {
          c.l.w.error("Creation of vertex buffer failed.");
          return false;
        }
        this.indexBuffer = this.a.createBuffer();
        ...
        this.a.kc(0);
        this.a.kc(1);
        this.a.bindAttribLocation(this.program, 0, "aVertexPosition");
        this.a.bindAttribLocation(this.program, 1, "aTextureCoord");
        this.id = this.a.linkProgram(this.program);
        if (0 > this.v) return this.a.deleteProgram(this.program), c.l.w.error("Program linking failed."), false;
        this.bg = this.a.getUniformLocation(this.program, "uColorMap");
        this.Lk = this.a.getUniformLocation(this.program, "uCoverageMap");
      ...
      b.prototype.destroy = function () {
        this.a.deleteBuffer(this.vertexBuffer);
        this.a.deleteBuffer(this.indexBuffer);
        this.a.deleteShader(this.vertexShader);
        this.a.deleteShader(this.fragmentShader);
        this.a.deleteProgram(this.program)
      };
    ...
    var f = function () {
      ...
      b.prototype.Ua =
        function () {
          ...
          this.id = this.a.linkProgram(this.program);
          if (0 > this.v) return this.a.deleteProgram(this.program), c.l.w.error("Program linking failed."), false;
          var a = this.a.getUniformLocation(this.program, "uSamplers"),
            b = this.a.getUniformLocation(this.program, "uSamplerIndex"),
            f = this.a.getUniformLocation(this.program, "uColorXformMultiplier"),
            e = this.a.getUniformLocation(this.program,
              "uColorXformOffset"),
            k = this.a.getUniformLocation(this.program, "uOverflowTypeAndPassIndex"),
            l = this.a.getUniformLocation(this.program, "uFrame"),
            s = new d.q(this.a.getUniformLocation(this.program, "uMVMatrix"), d.d.FLOAT_MAT4, 1, d.q.Jd),
          ...
          this.o.uFrame = l;
          a = this.a.getAttribLocation(this.program, "aLoopBlinnTextureCoord");
          k = this.a.getAttribLocation(this.program, "aIsConvex");
          l = this.a.getAttribLocation(this.program, "aTextureCoord");
          s = new d.R(this.a.getAttribLocation(this.program, "aVertexPosition"), "POSITION0", d.d.FLOAT, 2);
          a = new d.R(a, "TEXCOORD0", d.d.FLOAT, 2);
          k = new d.R(k, "TEXCOORD1", d.d.FLOAT, 1);
          l = new d.R(l, "TEXCOORD2", d.d.FLOAT, 2);
          this.attribs = new c.e.Oe([s,
            a, k, l
          ]);
          return true
        };
  ...
  (function (d) {
    var f = function () {
      ...
      b.prototype.Ua = function () {
        ...
        this.id = this.a.linkProgram(this.program);
        if (0 > this.v) return this.a.deleteProgram(this.program), c.l.w.error("Program linking failed."), false;
        var a = this.a.getUniformLocation(this.program, "uMVMatrixInv"),
          b = this.a.getUniformLocation(this.program, "uSampler"),
          f = this.a.getUniformLocation(this.program, "uColorXformMultiplier"),
          e = this.a.getUniformLocation(this.program, "uColorXformOffset"),
          k = this.a.getUniformLocation(this.program, "uOverflowTypeAndPassIndex"),
          l = this.a.getUniformLocation(this.program, "uFrame"),
          s = new d.q(this.a.getUniformLocation(this.program, "uMVMatrix"), d.d.FLOAT_MAT4, 1, d.q.Jd),
        ...
        this.o.uFrame = l;
        a = this.a.getAttribLocation(this.program, "aLoopBlinnTextureCoord");
        b = this.a.getAttribLocation(this.program, "aIsConvex");
        e = this.a.getAttribLocation(this.program, "aTextureCoord");
        k = this.a.getAttribLocation(this.program, "adfdx");
        l = this.a.getAttribLocation(this.program, "adfdy");
        s = new d.R(this.a.getAttribLocation(this.program, "aVertexPosition"), "POSITION0", d.d.FLOAT, 2);
        a = new d.R(a, "TEXCOORD0", d.d.FLOAT, 2);
  ...
  (function (d) {
    var f = function () {
      ...
      b.prototype.ld = function () {
        ...
        this.a.clearColor(a.red / 255, a.green / 255, a.blue / 255, a.alpha / 255);
  ...
  (function (d) {
    var f = function () {
      ...
      b.prototype.Xl = function (a, d) {
        ...
        if (void 0 !== f) return f = new c.c.M(f.x, f.y, a, d), e = c.l.U.em(this.qe.getID(), this.ol++), this.qe.setFrame(e, f), e
      };
  ...
  (function (d) {
    ...
    var f = function () {
      function b(a, b, d, e, f, l) {
        ...
        this.Rd = e;
        this.hc = f.clone();
        this.dg = void 0 !== l ? l.clone() : new c.c.p;
        this.ug = 0
      }
      b.prototype.Cd = z("Nl");
      b.prototype.Bd = z("yc");
      b.prototype.getColor = z("Rd");
      b.prototype.ub = z("hc");
      b.prototype.La = z("dg");
    ...
    f = function () {
      ...
      b.prototype.destroy = function () {
        void 0 !== this.Mb && this.Mb.Wj();
        this.Mb = void 0;
        void 0 !== this.Da && this.Da.destroy();
        this.Da = void 0
      };
      return b
    }();
  ...
  (function (d) {
    ...
    f = function () {
      ...
      b.prototype.nn = function (a) {
        if (void 0 === a.Li || void 0 === a.getColor() || void 0 === a.pa) return false;
        this.wc.push(a);
        return true
      };
      b.prototype.Qn = function () {
        ...
        if (0 !== a) {
          for (var b = 0; b < a; ++b) {
            var f = this.wc[b].Li,
              e = this.wc[b].getColor(),
              k = this.wc[b].tl,
              l = this.wc[b].pa,
              s = f.getGlobalTransform().clone(),
              m = f.getGlobalColorTransform(),
              n = this.Ik(f),
              m = this.Qk(f.Ic().getID(), e, n, m);
            void 0 === m ? m = this.pa(f, e, n, k) : this.ml(f);
            void 0 !== m ? (l.In(m), e = this.Ti.kj(m.Bd().getID(), this.Ti.rm()), l.Hn(e), l.Ea(s), f.$j(l)) : (f.$j(void 0), l.destroy())
          }
          this.wc.length = 0;
      ...
      b.prototype.Qk = function (a, b, c, e) {
        ...
        if (void 0 !== a)
          for (var d = 0; d < a.length; ++d) {
            var f = a[d];
            if (f.getColor().equals(b) && this.el(c, f.ub()) && f.La().equals(e)) return f
          }
      };
      ...
      b.prototype.pa = function (a, b, d, e) {
        ...
        if (m.left && !isNaN(m.left)) {
          ...
          if (void 0 === y) a.Ea(f, e);
            ...
            else return n = this.ce[a.Ic().getID()], void 0 === n && (n = [], this.ce[a.Ic().getID()] = n), d = new c.e.wk(y.Cd(), f, a.Ic().getID(), b, d, a.getGlobalColorTransform()), n.push(d), n = y.getFrame(w), s.Ga(l), l = s.get(0, 3), f = s.get(1, 3), s.translate(n.left + (l - Math.floor(l)),
      ...
      b.prototype.Sk = function (a, b, f, e, k, l) {
        ...
        f = new d.Pd(a[0], s);
        n = new d.ca(k, l);
        n.Ke(c.e.ca.fillMode[c.e.ca.kFill_Repeat]);
        n.xe(e, [f]);
        n.we(b[0]);
        m[0] = n;
        1 < a.length && (f = new d.Pd(a[1], s), n = new d.ca(k, l), n.Ke(c.e.ca.fillMode[c.e.ca.kFill_Repeat]), n.xe(e, [f]), n.we(b[1]), m[1] = n);
        2 < a.length && (a = new d.Pd(a[2], s), k = new d.ca(k, l), k.Ke(c.e.ca.fillMode[c.e.ca.kFill_Repeat]), k.xe(e, [a]), k.we(b[2]), m[2] = k);
        return m
      };
...
(function (c) {
  var d = function () {
    ...
    d.prototype.init = function (canvas, content, textures, callback, options) {
      ...
      this.options[d.kOption_StandardDerivatives] = this.a.hasExtension("OES_standard_derivatives");
      this.nd = undefined;
      ...
      if (b) {
        ...
        this.scenegraphFactory = new flwebgl.sg.SceneGraphFactory(this.hb, this.ge.ac + 1);
        ...
        if (textures && textures.length > 0) {
          this.a.xh(this.Ta.getTextureAtlases(), c.l.U.bind(this, "_texturesLoadedCBK"))
        } else {
    ...
    d.prototype.destroy = function () {
      this.stop();
      this.ge && (this.ge.destroy(), delete this.ge);
      this.Ta && (this.Ta.destroy(), delete this.Ta);
      this.a && (this.a.destroy(), delete this.a);
      this.stage && (this.stage.destroy(), delete this.stage);
      this.Ac && (this.Ac.destroy(), delete this.Ac);
