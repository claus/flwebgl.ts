  ...
  (function (d) {
    var f = function () {
      function b(a) {
        ...
        this.b = Array(16);
        this.identity();
        void 0 !== a && 6 <= a.length && this.setValues(a)
      }
      ...
      b.prototype.Rb = function () {
        ...
        var a = this.b[0],
          ...
          l = this.b[13],
          c = h * b - a * e;
        if (0 == c) return this.identity(), this;
        this.identity();
        this.b[0] = -e / c;
        this.b[1] = h / c;
        this.b[4] = b / c;
      ...
      b.prototype.qm = function () {
        if (-1 === this.gd) {
          for (var a = this.um(), h = a.length, b = 0; b < h; ++b) {
            var e = a[b];
            e.getID() > this.gd && (this.gd = e.getID())
          }
          a = this.zm();
          h = a.length;
          for (b = 0; b < h; ++b) e = a[b], e.getID() > this.gd && (this.gd = e.getID())
        }
        return ++this.gd
      };
  ...
  (function (d) {
    var f = function (b) {
      ...
      a.prototype.Je = function (a, b) {
        ...
        b && (this.W |= 2);
        this.ya = true;
        void 0 !== a ? this.Ra = a.C() : this.Ra.identity()
      };
...
N.sg = N.g;
N.g.Shape = N.g.G;
N.g.G.prototype.setVisible = N.g.G.prototype.setVisible;
N.g.G.prototype.isVisible = N.g.G.prototype.isVisible;
  ...
  (function (d) {
    var f = function (b) {
      ...
      a.prototype.Ob = function (a) {
        if (0 > a) return -1;
        for (var b = 0; b < this.m.length; ++b)
          if (this.m[b] && this.m[b].getID() == a) return b;
        for (b = 0; b < this.Y.length; ++b)
      ...
      a.prototype.Ea = function (a, b) {
        ...
        void 0 !== this.pa && (this.za.equals(this.pa.La()) ? this.pa.Ea(this.ea) : this.oi())
      };
      a.prototype.Fa = function () {
...
N.sg = N.g;
N.g.MovieClip = N.g.j;
N.g.j.prototype.setName = N.g.j.prototype.setName;
N.g.j.prototype.getName = N.g.j.prototype.getName;
N.g.j.prototype.setVisible = N.g.j.prototype.setVisible;
N.g.j.prototype.isVisible = N.g.j.prototype.isVisible;
    ...
    var f = function () {
      ...
      b.prototype.execute = function (a, b) {
        ...
        if (0 <= k) {
          ...
          0 === (c.W & 2) && (e = c.xf().C(), e.identity(), c.Je(e, false));
          for (e = a.Ob(this.hf) + 1; a.ia(e) && 0 > a.ia(e).getID();) e++;
          e > k && e--;
          a.vh(k, e);
          0 === (c.W & 4) && c.setVisible(true, false);
          return true
        }
        return 0 > this.Ek(a,
          c, e) ? false : true
      ...
      b.prototype.Ek = function (a, b, c) {
        ...
        e.Kd(this.hc, false);
        void 0 !== this.Gi && e.setName(this.Gi);
        for (b = a.Ob(this.hf) + 1; a.ia(b) && 0 > a.ia(b).getID();) b++;
  ...
  (function (d) {
    var f = function () {
      ...
      b.prototype.execute = function (a) {
        var b = a.Ob(this.X);
        if (0 > b) return false;
        for (var c = a.ia(b), e = a.Ob(this.hf) + 1; a.ia(e) && 0 > a.ia(e).getID();) e++;
        e > b && e--;
        b != e && a.vh(b, e);
        0 === (c.W & 1) && c.Kd(this.hc, false);
        return true
      ...
      b.prototype.init = function (a, b, h) {
        if (void 0 !== b)
          for (var k = 0; k < b.length; k++)
            if (!this.vl(b[k].getTextureJSON(), b[k].getImageURL(), k)) return;
        return this.ul(a, h)
      };
      b.prototype.s = function () {
        return true
      ...
      b.prototype.pa = function (a, b, d, e) {
        ...
        if (m.left && !isNaN(m.left)) {
          ...
          if (void 0 === y) a.Ea(f, e);
            ...
            else return n = this.ce[a.Ic().getID()], void 0 === n && (n = [], this.ce[a.Ic().getID()] = n), d = new c.e.wk(y.Cd(), f, a.Ic().getID(), b, d, a.Gc()), n.push(d), n = y.$a(w), s.Ga(l), l = s.get(0, 3), f = s.get(1, 3), s.translate(n.left + (l - Math.floor(l)),
  ...
  (function (d) {
    var f = function () {
      ...
      b.prototype.dm = function (a) {
        a = this.hb.T.Am(a);
        return void 0 === a || a.fl ? void 0 : this.Yg(a.getID(), -1)
      };
...
(function (c) {
  var d = function () {
    ...
    d.prototype.init = function (canvas, content, textures, callback, options) {
      ...
      this.gb = canvas;
      try {
        this.a = new c.e.Hh(this.gb, options);
      } catch (k) {
      ...
      if (b) {
        ...
        this.scenegraphFactory = new c.g.Qe(this.hb, this.ge.ac + 1);
        ...
        this.backgroundColor = b.Mn;
        this.stageWidth = b.On;
        this.stageHeight = b.Nn;
        this.frameRate = b.jm;
        this.Ki = b.loop;
        this.ke = b.qn;
    ...
    d.prototype.play = function (b) {
      ...
      if (b && b.length) {
        for (var p = false, e = 0; e < this.ke.length; e++)
          if (this.Ta.zf(this.ke[e]).getName() === b) {
            a = e;
            p = true;
            this.jd = false;
            break;
      ...
      this.Jg = d.Qh;
      this.xc = c.l.U.requestAnimationFrame(this.qg, this.frameRate, window);
      return true
    };
    ...
    d.prototype.Al = function () {
      ...
      if (this.stage)
        for (b = this.stage.Ad() - 1; 0 <= b; --b) {
          var a = this.stage.ia(b);
          this.stage.Ge(b);
          a.s()
        }
    };
    d.prototype._loop = function () {
      try {
        if (this.Jg !== d.Qh) this.gb.removeEventListener("webglcontextlost", this.Di, false), this.gb.removeEventListener("webglcontextrestored",
          ...
          this.Xe == this.Hi && (this.Gk(), this.Xe = (this.Xe + 1) % (this.frameRate + 1));
          var a = (new Date).getTime() - this.dc;
          this.frameDuration > a && this.frameDuration - a < b ? (this.xc && (c.l.U.cancelAnimationFrame(this.xc, window), this.xc = void 0), this.Lg = window.setTimeout(this.qg, this.frameDuration - a)) : a >= this.frameDuration && (this.Sl(), this.Pk())
        }
      } catch (h) {
    ...
    d.prototype.Gk = function () {
      this.stage.Ae() === this.li && this.stage.yj() && this.jd && (this.Ki || this.rc !== this.ke.length - 1) && this.Ri((this.rc + 1) % this.ke.length);
      this.stage.Ne();
      this.stage.yh();
      this.stage.Pc();
      this.stage.Qf();
