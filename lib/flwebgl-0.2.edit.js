  ...
  (function (d) {
    var f = function () {
      ...
      b.prototype.setViewport = function (rect, flipY) {
        ...
        var multY = flipY ? -1 : 1;
        this.kf = new c.c.u([ 2 / rect.width, 0, 0, 2 * multY / rect.height, -1, -1 * multY ]);
      };
      ...
      b.prototype.wd = function (width, height, format, internalFormat) {
        ...
        if (frameBuffer === void 0) {
          ...
          this.bindFramebuffer(b.FRAMEBUFFER, this.ha.frameBuffer);
        }
      ...
      b.prototype.Ha = function (a) {
        ...
        if (a.frameBuffer !== this.ha.frameBuffer) {
      ...
      b.prototype.toggleDepthTest = function (a) {
      ...
      b.prototype.setUniforms = function (shader, c) {
        var d = c.Ce(shader.getID());
        var e = this.Pg[shader.getID()];
        if (!e) {
          e = this.Pg[shader.getID()] = {};
        }
