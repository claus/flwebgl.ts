...
(function (c) {
  (function (c) {
    var f = function () {
      function b(id, name, b, e, frameLabels, l) {
        this.id = id;
        this.name = name;
        this.$d = [];
        this.il = b;
        ...
        for (var i = 0; i < l.length; i++) {
          ...
          this.le[l[i].Ka].push(l[i].functionName);
        }
      }
      b.prototype.getID = z("id");
      b.prototype.getName = z("name");
      b.prototype.getFrameLabels = z("frameLabels");
  ...
  (function (d) {
    var f = function (b) {
      ...
      a.prototype.Bi = function (a, b) {
        if ("string" === typeof a) {
          for (var e = this.Va.getFrameLabels(), k = false, l = e.length - 1; 0 <= l; l--)
            if (a === e[l].name) {
              a = e[l].Ka;
              k = true;
              break
      ...
      a.prototype.Ne = function (a, b) {
        ...
        if (e) {
          ...
          if (this.xa == this.re) this.Ji(a), this.Pc(a);
            ...
            for (var k = this.Va.pj(this.xa), l = 0; l < k.length; ++l) k[l].execute(this, this.canvas, e);
            this.Td = false
          }
          this.df = true
        }
      ...
      a.prototype.getCurrentFrameLabel = function () {
        for (var a = this.Va.getFrameLabels(), b = a.length - 1; 0 <=
          b; b--)
          if (this.getCurrentFrame() == a[b].Ka) return a[b].name
      };
      a.prototype.getCurrentLabel = function () {
        for (var a = this.Va.getFrameLabels(), b = void 0, e = this.getCurrentFrame(), k = -1, l = 0; l < a.length; l++) a[l].Ka >= k && a[l].Ka <= e && (b = a[l].name, k = a[l].Ka);
        return b
      };
      a.prototype.Nf = g("Ba");
      ...
      a.prototype.Ea = function (a, b) {
        a ? (this.globalTransform.copy(a), this.globalTransform.Ga(this.localTransform)) : this.globalTransform.copy(this.localTransform);
        b ? (this.globalColorTransform.copy(b), this.globalColorTransform.concat(this.localColorTransform)) : this.globalColorTransform.copy(this.localColorTransform);
        for (var e = 0; e < this.children.length; ++e) this.children[e].Ea(this.globalTransform, this.globalColorTransform);
        void 0 !== this.pa && (this.globalColorTransform.equals(this.pa.La()) ? this.pa.Ea(this.globalTransform) : this.oi())
      };
      a.prototype.Fa = function () {
        return this.globalTransform.get(2, 2)
      };
...
(function (c) {
  var d = function () {
    ...
    d.prototype.Gk = function () {
      if (this.stage.getCurrentFrame() === this.li && this.stage.isPlaying() && this.jd && (this.Ki || this.rc !== this.ke.length - 1)) {
        this.Ri((this.rc + 1) % this.ke.length);
      }
      this.stage.Ne();
      this.stage.yh();
      this.stage.Pc();
