  ...
  (function (d) {
    var f = function (b) {
      ...
      a.prototype.setChildIndex = function (displayObject, index) {
        this.vh(this.getChildIndex(displayObject), index);
      };
      ...
      a.prototype.gotoFrame = function (frameNum, stop) {
        ...
        if (frameNum >= 1 && frameNum <= this.re && frameNum != this.xa + 1) {
          ...
          while (this.xa + 1 < frameNum) {
            e = (frameNum == this.xa + 1 + 1);
      ...
      a.prototype.advanceFrame = function (a, b) {
        ...
        if (e && !this._loop && this.xa == this.re - 1) { e = false; }
        if (e && this.xa == 0 && this.re == 1) { e = false; }
        if (e) {
          if (++this.xa == this.re) {
            this.Ji(a);
            ...
            var k = this.Va.getFrameCmds(this.xa);
            for (var l = 0; l < k.length; ++l) {
              k[l].execute(this, this.canvas, e);
            }
            this.Td = false;
          }
          this.df = true;
        ...
        if (!a) {
          for (e = 0; e < this.children.length; e++) {
            if (this.children[e] instanceof c.g.j) {
              this.children[e].advanceFrame(a);
            }
          }
          for (e = 0; e < this.Y.length; e++) {
            if (this.Y[e].vd instanceof c.g.j) {
              this.Y[e].vd.advanceFrame(a);
            }
          }
        }
      };
      ...
      a.prototype.executeFrameScripts = function () {
        if (this.df) {
          var a = this.Va.getScriptFunctionNames(this.xa);
      ...
      a.prototype.Ji = function (a) {
        ...
        for (k = 0; k < this.getNumChildren(); ++k)
          if (l = this.getChildAt(k), -1 !== l.getID()) {
            ...
            d && (this.removeChildAt(k), l.destroy(), --k)
          }
      ...
      a.prototype.oi = function () {
        void 0 !== this.pa && (this.pa.destroy(), this.pa = void 0)
      };
      a.prototype.Qb = function (a) {
        if (this.isVisible()) {
          if (void 0 === this.pa) {
      ...
      a.prototype.getBounds = function (a, b, e, k) {
        ...
        "undefined" === typeof k && (k = false);
        void 0 === a && (a = this);
        for (var l = new c.c.M, d = 0; d < this.children.length; ++d) l.union(this.children[d].getBounds(a, b, e, k));
        return l
      };
...
(function (c) {
  (function (d) {
    var f = function () {
      ...
      b.sm = function (a) {
        var b = a.getGlobalTransform().clone();
        a = a.getLocalTransform().clone();
        a.invert();
        b.Ga(a);
        return b
      };
    ...
    var b = function () {
      ...
      b.prototype.Vk = function (a, h, e, d, p) {
        if (!(0 >= d || 6 != p.length)) {
          ...
          var f = p.Jm();
          f || p.invert();
          for (var t = 0, q = e; t < h * d; t += h, q += h) f ? a[q] = 0.5 : (e = p.transformPoint(new c.c.k(a[t], a[t + 1])), a[q] = e.x), a[q + 1] = 0.5
        }
      };
      b.prototype.Uk = function (a, b, h, k, e, d, p) {
        if (!(0 >= k || 6 != e.length))
          for (e = new c.c.u(e), e.invert(), d /= 20, p /= 20, e.set(0, 0, e.get(0, 0) / d), e.set(1, 0, e.get(1, 0) / p), e.set(0, 1, e.get(0, 1) / d), e.set(1, 1, e.get(1, 1) / p), e.set(0, 3, e.get(0, 3) / d), e.set(1, 3, e.get(1, 3) / p), p = 0, d = h; p < b * k; p += b, d += b) h = e.transformPoint(new c.c.k(a[p], a[p + 1])), a[d] = h.x, a[d + 1] = h.y
      };
