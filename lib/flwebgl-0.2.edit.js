  ...
  (function (d) {
    var f = function (b) {
      ...
      a.prototype.getBounds = function (a, b, e, k) {
        ...
        return b ? a.transformBoundsAABB(this.yc.pg) : this.cl(e, a);
      };
  ...
  (function (d) {
    ...
    var b = function () {
      ...
      b.prototype.If = function (a, b, h, k, e, d, p,  f, r, u, A) {
        ...
        var C = [];
        if (f.length <= 0 && r.length <= 0 && u.length <= 0 && A.length <= 0) {
          return C;
        }
        var v = [];
        var x = c.e.t.Z;
      ...
      b.prototype.xl = function (a, b) {
        var h = [];
        var k = 0;
        var d = [ new c.c.k(0, 1), new c.c.k(0, 1), new c.c.k(0, 1) ];
        var e = 0;
        while (e < b.length) {
          k = e;
          e = (b.length - e > c.e.d.la) ? e + c.e.d.la : b.length;
          k = this.af(a, b, k, e, d, 100000);
          h.push(k);
        }
        return h;
      };
      b.prototype.wl = function (a, h, e, d) {
        ...
        var u = 0;
        var A = 0;
        var C = h.length + e.length + d.length;
        var v = [ b.Me[0], b.Me[1], b.Me[2] ];
        var x = [ new c.c.k(0, 0), new c.c.k(0, 1), new c.c.k(0, 0) ];
        while (t < C) {
          var w = t,
        ...
        for (var i = 0; i < p.length; i++) {
          ...
          if (frame !== void 0) {
            ...
            switch (k) {
              case a.kSolid:
              case e.kSolid:
                this.Wk(b.ba, this.S, offset, A, r, frame, b.Ma.length);
                break;
              case a.kLinearGradient:
              case e.kLinearGradient:
                this.Vk(b.ba, this.S, offset, b.Ma.length, c);
                break;
              case a.kBitmap:
              case e.kBitmap:
                this.Uk(b.ba, this.S, offset, b.Ma.length, c, frame.width, frame.height);
                break;
            }
      ...
      b.prototype.Wk = function (a, stride, offset, k, e, frame, p) {
        if (p > 0) {
          var d = new c.c.k(frame.left + frame.width / 2, frame.top + frame.height / 2);
          d.x /= k;
          d.y /= e;
          for (k = 0; k < p; k++) {
            a[offset] = d.x;
      ...
      b.prototype.Vk = function (a, stride, offset, d, p) {
        if (d > 0 && p.length == 6) {
          p = new c.c.u(p);
          p.Ga(b.Km);
          var f = p.Jm();
          ...
          while (t < stride * d) {
            if (f) {
              ...
              var e = p.transformPoint(new c.c.k(a[t], a[t + 1]));
              a[q] = e.x;
            }
            a[q + 1] = 0.5;
            t += stride;
      ...
      b.prototype.Uk = function (a, stride, offset, k, e, d, p) {
        if (k > 0 && e.length == 6) {
          e = new c.c.u(e);
          e.invert();
          d /= 20;
          p /= 20;
          e.set(0, 0, e.get(0, 0) / d);
          e.set(1, 0, e.get(1, 0) / p);
          e.set(0, 1, e.get(0, 1) / d);
          e.set(1, 1, e.get(1, 1) / p);
          e.set(0, 3, e.get(0, 3) / d);
          e.set(1, 3, e.get(1, 3) / p);
          p = 0;
          d = offset;
          while (p < stride * k) {
            var h = e.transformPoint(new c.c.k(a[p], a[p + 1]));
            a[d] = h.x;
            a[d + 1] = h.y;
            p += stride;
            d += stride;
      ...
      a.prototype.parseShapes = function () {
        ...
        for (var h = 0; h < b.length; h++) {
          ...
          for (var p = 0; p < e.length; ++p) {
            ...
            var f = this.Kb.If(vertices, fillName, fillStyle, fillXForm, v, x, fillIsOpaque, q);
            var q = this.Kb.If(vertices, fillName, fillStyle, fillXForm, v, x, fillIsOpaque, [], u, A, r);
            var t = this.Kb.dj(vertices, u, A, r, fillName, fillStyle, fillIsOpaque, fillXForm, v, x);
            if (f.length) {
  ...
  (function (d) {
    var f = function () {
      ...
      b.prototype.Vg = function (a, b) {
        ...
        if (void 0 === this.rd[c]) {
          var e = d.d.la * this.Oa.ta[0].totalSize * Float32Array.BYTES_PER_ELEMENT,
