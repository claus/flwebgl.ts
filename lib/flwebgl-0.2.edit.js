...
(function (c) {
  var d = function () {
    ...
    d.prototype.init = function (canvas, content, textures, callback, options) {
      if (canvas == undefined || content == undefined) {
      ...
      if (b) {
        ...
        this.Ki = b.loop;
        this.ke = b.qn;
        this.a.setBackgroundColor(this.Te);
        if (this.bd < 0) {
          this.bd = 1;
        }
        this.bf = 1000 / this.bd;
        this.I = this.scenegraphFactory.Yg(void 0, -1);
        this.hb.Kn(this.I);
        this.I.Cn(this.Ki);
        return d.S_OK;
      } else {
