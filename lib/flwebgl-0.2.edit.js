    ...
    var f = function () {
      ...
      a.prototype.destroy = function () {
        for (var a in this.Xc)
          for (var b = this.Xc[a], e = 0; e < b.length; e++) {
            ...
            for (var c = this.Sd[c.getID()], d = 0; d < c.length; ++d) this.gl.deleteBuffer(c[d])
          }
        if (this.qf) {
          for (a in this.ic) this.gl.gm(this.ic[a]);
          delete this.ic
        }
        delete this.Xc;
      ...
      a.prototype.Si = function (a, b, e) {
        ...
        var k = this.Qd[a],
          l = this.Sd[a],
          f = false,
          m = this.gl.$g(c.d.ARRAY_BUFFER);
        0 === b.length && (f = true);
        m !== k && (this.gl.ga(c.d.ARRAY_BUFFER, k), void 0 !== this.ag && this.ag(a));
        ...
        if (void 0 === this.ic[a]) {
          ...
          n = y.attrs;
          y = y.totalSize;
          this.qf && (this.ic[a] = this.gl.fm(),
            this.gl.td(this.ic[a]));
          ...
          this.qf && this.gl.td(null)
        } else m = this.ic[a], this.gl.td(m);
        for (var q = 1; q < k.length; ++q) {
          this.gl.ga(c.d.ARRAY_BUFFER, l[q - 1]);
      ...
      a.prototype.Ci = function (a) {
        ...
        this.gl.ga(c.d.ARRAY_BUFFER, this.Qd[k.getID()]);
        this.gl.tf(c.d.ARRAY_BUFFER, p, c.d.DYNAMIC_DRAW);
        ...
        for (e = 1; e < a.ta.length; ++e) {
          ...
          this.gl.ga(c.d.ARRAY_BUFFER, l);
          this.gl.tf(c.d.ARRAY_BUFFER, p, c.d.DYNAMIC_DRAW)
        }
        this.gl.ga(c.d.ARRAY_BUFFER, null);
        this.Si(k.getID());
        return k
      };
      a.Aj = "maxbuffers";
  ...
  (function (d) {
    var f = function () {
      ...
      b.prototype.Vg = function (a, b) {
        ...
        if (void 0 === this.rd[c]) {
          var e = d.d.MAX_VERTICES * this.Oa.ta[0].totalSize * Float32Array.BYTES_PER_ELEMENT,
            k = this.gl.createBuffer();
          this.gl.ga(d.d.ARRAY_BUFFER, k);
          this.gl.tf(d.d.ARRAY_BUFFER, e, d.d.DYNAMIC_DRAW);
          this.oe();
          this.rd[c] = k
        }
        this.Cg = this.rd[c];
      ...
      b.prototype.Zg = function () {
        this.gl.$g(d.d.ARRAY_BUFFER) !== this.Cg && (this.gl.ga(d.d.ARRAY_BUFFER, this.Cg),
          this.oe());
      ...
      b.prototype.destroy = function () {
        for (var a in this.rd) this.gl.deleteBuffer(this.rd[a]);
    ...
    var b = function () {
      ...
      b.prototype.Zg = function (a) {
        if (!a) {
          ...
          if (void 0 === a) {
            ...
            b = this.zb[this.qa][b];
            h = this.gl.$g(d.d.ARRAY_BUFFER);
            if (void 0 === h || h !== b) {
              this.gl.ga(d.d.ARRAY_BUFFER, b);
              this.oe();
            }
            b = [];
      ...
      b.prototype.Yf = function () {
        ...
        if (void 0 === b) {
          ...
          this.gl.ga(d.d.ARRAY_BUFFER, b);
          this.gl.tf(d.d.ARRAY_BUFFER, h, d.d.DYNAMIC_DRAW);
          this.oe();
...
(function (c) {
  (function (d) {
    var f = function () {
      ...
      b.prototype.Xb = function () {
        this.gl.useProgram(this.program);
        this.gl.ga(d.d.ARRAY_BUFFER, this.vertexBuffer);
        this.gl.ga(d.d.ELEMENT_ARRAY_BUFFER, this.indexBuffer);
        this.gl.useProgram(this.program);
  ...
  (function (d) {
    var f = function () {
      ...
      b.prototype.Ia = function (a, b) {
        for (var c = a.F.length, e = this.gl.kf, f = 0; f < c; ++f) {
          var l = a.mc(f);
          if (l.Jc()) {
            var s = l.ka.ad,
              m = this.gl.Be(s),
      ...
      b.prototype.Ua =
        function () {
          ...
          var a = this.gl.getUniformLocation(this.program, "uSamplers"),
            ...
            e = this.gl.getUniformLocation(this.program,
              "uColorXformOffset"),
    ...
    var f = function () {
      ...
      b.prototype.ld = function () {
        ...
        var a = this.gl.getViewport(),
          b = this.Yk();
        this.Yc = this.Ue[b];
        void 0 === this.Yc && (this.Yc = this.gl.wd(a.width, a.height), this.Ue[b] = this.Yc);
        this.Zc = this.We[b];
        void 0 === this.Zc && (this.Zc = this.gl.wd(a.width, a.height), this.We[b] = this.Zc);
        this.gl.Ha(this.Yc);
        a = this.gl.getBackgroundColor();
        this.gl.clearColor(a.red / 255, a.green / 255, a.blue / 255, a.alpha / 255);
      ...
      b.prototype.Qg = function (a) {
        ...
        for (var c = a.length, f = 0; f < c; ++f) {
          ...
          for (k = 0; k < e.ra(d.t.P); k++) l = e.ab(d.t.P, k, this.gl), l.getIsOpaque() && this.cg.Dc(l)
        }
        f = e = 0;
        for (l = []; e < c;) {
          for (var s = a[e].Fa(), m = s, n = -1, y = [], w = [], t = this.yi(), q = this.yi(), k = e; k < c; ++k, ++f) {
            for (var e = a[k], r = e.Fa(), u = false, A = e.ra(d.t.Z), C = e.ra(d.t.P), v = 0; !u && v < A; ++v) u = !e.ab(d.t.Z, v, this.gl).getIsOpaque();
            for (v = 0; !u && v < C; ++v) u = !e.ab(d.t.P, v, this.gl).getIsOpaque();
            if (u) {
              n = r;
      ...
      b.prototype.destroy = function () {
        this.Pa.destroy();
        this.Ve.destroy();
        for (var a in this.Ue) this.gl.ye(this.Ue[a]);
        for (a in this.We) this.gl.ye(this.We[a])
      };
      b.oc = 0;
      b.Tb = 1;
      b.Mc = 2;
  ...
  (function (d) {
    var f = function () {
      ...
      b.prototype.O = function (a) {
        ...
        this.ha = this.gl.wd(b.width, b.height);
        var b = this.gl.getBackgroundColor(),
          f = new c.c.Qc(0, 0, 0, 0),
          e = this.gl.Ha(this.ha);
    ...
    f = function () {
      ...
      b.prototype.Tk = function (a, b, d, e, f) {
        if (a !== void 0 && d !== void 0 && e !== void 0) {
          ...
          var s = this.gl.H.hasExtension("OES_standard_derivatives") ? 7 : 11;
          a = this.Xk(s, a, b);
...
(function (c) {
  var d = function () {
    ...
    d.prototype.init = function (canvas, content, textures, callback, options) {
      ...
      this.ge = new c.xj.sk(this.assetPool);
      ...
      if (b) {
        ...
        if (textures && textures.length > 0) {
          this.gl.xh(this.assetPool.getTextureAtlases(), c.l.U.bind(this, "_texturesLoadedCBK"))
        } else {
    ...
    d.prototype.Pk = function () {
      ...
      this.me();
      this.gl.ij();
      for (var b = this.oa.length, a = 0; a < b; ++a) this.oa[a].He(a / b), this.gl.e(this.oa[a], 1);
      this.gl.lj();
