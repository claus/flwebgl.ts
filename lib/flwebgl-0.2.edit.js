  ...
  (function (d) {
    var f = function () {
      ...
      b.prototype.ak = function (a) {
        void 0 !== a && 6 <= a.length && (this.b[0] = a[0], this.b[1] = a[1], this.b[4] = a[2], this.b[5] = a[3], this.b[12] = a[4], this.b[13] = a[5], 1 != a[0] || 1 != a[3] || 0 != a[1] || 0 != a[2] || 0 != a[4] || 0 != a[5]) && (this.L = false)
      };
...
(function (c) {
  (function (c) {
    var f = function () {
      function b(a, h, b, e) {
        this.tc = true;
        void 0 !== a && (this.left = a, this.top = h, this.width = b, this.height = e, this.tc = false)
      }
...
(function (c) {
  (function (d) {
    var f = function (b) {
      ...
      a.prototype.Tg = function (b, p, e, k) {
        "undefined" === typeof e && (e = true);
        "undefined" === typeof k && (k = false);
        if (void 0 == p || null == p || p > this.Ad()) return false;
        0 > p && (p = 0);
        e && b.Lf(-1);
        ...
        if (b instanceof a) {
          ...
          p == this.gb.getStage() && 0 == b.Ae() && (b.Ne(), b.yh(), b.Pc(), b.Qf(), b.Rf(), b.Sf())
        }
        return true
      };
      ...
      a.prototype.Bi = function (a, b) {
        if ("string" === typeof a) {
          for (var e = this.Va.zd(), k = false, l = e.length - 1; 0 <= l; l--)
            if (a === e[l].name) {
              a = e[l].Ka;
              k = true;
              break
        ...
        if (!(1 > a || a > this.re) && a != this.xa + 1) {
          ...
          for (; this.xa + 1 < a;) e = a == this.xa + 1 + 1, this.Ne(true, e), this.Pc(!e);
          false === b ? this.play() : this.stop();
          this.Qf();
          this.Rf();
          this.Sf()
        }
  ...
  (function (d) {
    var f = function () {
      ...
      b.prototype.execute = function (a, b) {
        ...
        if (0 <= k) {
          c = a.ia(k);
          0 === (c.W & 1) && c.Kd(this.hc, false);
          0 === (c.W & 2) && (e = c.xf().C(), e.ja(), c.Je(e, false));
          for (e = a.Ob(this.hf) + 1; a.ia(e) && 0 > a.ia(e).i();) e++;
          e > k && e--;
          a.vh(k, e);
          0 === (c.W & 4) && c.Le(true, false);
          return true
        }
        return 0 > this.Ek(a,
          c, e) ? false : true
      ...
      b.prototype.Ek = function (a, b, c) {
        ...
        return a.Tg(e, b, false, true) ? b : -1
      };
      return b
    }();
    d.Wf = f
...
(function (c) {
  (function (d) {
    ...
    var b = function () {
      ...
      b.prototype.init = function (a, b, h) {
        if (void 0 !== b)
      ...
      b.prototype.ul = function (h, d) {
        ...
        var p = h[b.Um],
          ...
          p = true == p[b.bn] ? new a(h, this, this.T) : new e(h, this, this.T);
        this.cd = false;
        this.S = 7;
        if (this.cd = d[c.n.kh]) this.S += 4;
        this.hi = d[c.n.kOption_CacheAsBitmap];
    ...
    var a = function () {
      ...
      a.prototype.Sj = function () {
        ...
        this.Xd = {};
        this.Yd = {};
        for (var h = 0; h < b.length; ++h) this.Xd[b[h][a.Gf]] = b[h][a.Id], this.Yd[b[h][a.Id]] = "T" == b[h][a.an] ? true : false, this.Zd[b[h][a.Id]] = b[h][a.gn];
        return true
      };
...
(function (c) {
  (function (d) {
    ...
    var b = function () {
      ...
      b.prototype.upload = function (a) {
        if (this.$f + a.sa() > c.e.d.la) return false;
        this.$f += a.sa();
        this.F.push(a);
        return true
      };
    ...
    var a = function () {
        ...
        a.prototype.Oi = function (a) {
          ...
          return e / this.Yn < this.Mm ? false : true
        };
  ...
  (function (d) {
    var f = function () {
      function b(a, h) {
        ...
        for (var p = ["webgl", "experimental-webgl", "webkit-3d", "moz-webgl"], e = 0; e < p.length; ++e) {
          try {
            this.f = a.getContext(p[e], {
              ...
              alpha: false,
              antialias: h[b.kOption_AAType] === b.kAAType_MSAA
        ...
        this.ii = false;
        this.ni = h[b.Fe];
        p = h[b.kOption_Caching];
        this.fb = (this.ii = p instanceof Object ? true : h[b.kOption_Caching]) ? new c.e.Se(p) : new c.e.Ck;
        this.fb.O(this);
        this.Pg = {};
        this.ql = 0
      }
      ...
      b.prototype.getBackgroundColor = z("Te");
      ...
      b.prototype.El = function () {
        ...
        b.ONE_MINUS_SRC_ALPHA = this.f.ONE_MINUS_SRC_ALPHA;
        ...
        b.ARRAY_BUFFER_BINDING = this.f.ARRAY_BUFFER_BINDING;
        ...
        b.SAMPLER_2D = this.f.SAMPLER_2D;
        ...
        b.FRAMEBUFFER = this.f.FRAMEBUFFER;
  ...
  (function (d) {
    ...
    f = function () {
      ...
      b.prototype.pa = function (a, b, d, e) {
        ...
        var m = a.ze(s, false, c.e.t.bb, true);
...
(function (c) {
  var d = function () {
    ...
    d.prototype.init = function (b, a, h, p, e) {
      if (b == undefined || a == undefined) {
        return d.E_INVALID_PARAM;
      }
      e = e | {};
      e[d.jh] = false;
      if (typeof e[d.Fe] === "undefined") { e[d.Fe] = false; }
      if (typeof e[d.kOption_Caching] === "undefined") { e[d.kOption_Caching] = true; }
      if (typeof e[d.kOption_CacheAsBitmap] === "undefined") { e[d.kOption_CacheAsBitmap] = true; }
      if (typeof e[d.kOption_AAType] === "undefined") { e[d.kOption_AAType] = d.kAAType_ImageSpace; }
      this.hd = e;
      this.gb = b;
      try {
      ...
      this.hd[d.kh] = this.a.Fc("OES_standard_derivatives");
      this.nd = undefined;
      this.Zf = p;
      this.ge = new c.xj.sk(this.Ta);
      return (b = this.ge.init(a, h, this.hd)) && void 0 !== b ? (this.hb = new c.nk(this.a, this.Ta, this.Ac), this.scenegraphFactory = new c.g.Qe(this.hb, this.ge.ac + 1), this.hd[d.kOption_CacheAsBitmap] && (this.nd = new c.e.xk(this.a, this.Ta, this.scenegraphFactory)), this.hb.Gn(this.scenegraphFactory), this.hb.Jn(this.nd), void 0 !== h && 0 < h.length ? this.a.xh(this.Ta.tj(), c.l.U.bind(this, "_texturesLoadedCBK")) : this._texturesLoadedCBK(), 0 < this.Ta.rj().length ? this.Ac.tn(this.Ta.rj(),
        c.l.U.bind(this, "_soundsLoadedCBK")) : this._soundsLoadedCBK(), this.Te = b.Mn, this.Yi = b.On, this.Xi = b.Nn, this.bd = b.jm, this.Ki = b.loop, this.ke = b.qn, this.a.setBackgroundColor(this.Te), 0 > this.bd && (this.bd = 1), this.bf = 1E3 / this.bd, this.I = this.scenegraphFactory.Yg(void 0, -1), this.hb.Kn(this.I), this.I.Cn(this.Ki), d.S_OK) : d.E_RESOURCE_LOADING_FAILED
    };
    ...
    d.prototype.play = function (b) {
      ...
      this.jd = true;
      if (b && b.length) {
        for (var p = false, e = 0; e < this.ke.length; e++)
      ...
      this.gb.addEventListener("webglcontextlost", this.Di, false);
      this.gb.addEventListener("webglcontextrestored", this.Ei, false);
    ...
    d.prototype.getStage = z("I");
    d.prototype.getStageWidth = z("Yi");
    d.prototype.getStageHeight = z("Xi");
    d.prototype.getBackgroundColor = z("Te");
    d.prototype.flush = function () {
      return void 0 != this.a ? (this.a.flush(), true) : false
    };
    d.prototype.setEventListener = function (b, a) {
      switch (b) {
        case d.FRAME_RENDER:
          this.$e = a
      }
    ...
    d.prototype._loop = function () {
      try {
        if (this.Jg !== d.Qh) this.gb.removeEventListener("webglcontextlost", this.Di, false), this.gb.removeEventListener("webglcontextrestored",
          this.Ei, false), void 0 !== this.xc && (c.l.U.cancelAnimationFrame(this.xc, window), this.xc = void 0), void 0 != this.Lg && window.clearTimeout(this.Lg);
        else {
          this.xc = c.l.U.requestAnimationFrame(this.qg, this.bd, window);
          this.Lg = void 0;
    ...
    d.prototype.Gk = function () {
      this.I.Ae() === this.li && this.I.yj() && this.jd && (this.Ki || this.rc !== this.ke.length - 1) && this.Ri((this.rc + 1) % this.ke.length);
      this.I.Ne();
      this.I.yh();
      this.I.Pc();
      this.I.Qf();
    ...
    d.prototype.Sl = function () {
      ...
      this.hd[d.kOption_CacheAsBitmap] && this.nd.Qn();
      this.oa = [];
      this.I.Qb(this.oa)
    };
